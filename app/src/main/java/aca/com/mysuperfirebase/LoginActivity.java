                            ...
                            public void onComplete(@NonNull Task<AuthResult> pTask) {
                                if(pTask.isSuccessful()){
                                    ...
                                    final DatabaseReference ref = FirebaseDatabase.getInstance().getReference()
                                            .child("users").child(user.getUid()).child("Name");
                                    ...
                                    ref.addValueEventListener(new ValueEventListener() {
                                        ...
                                        public void onDataChange(DataSnapshot pDataSnapshot) {
                                            ...
                                            startActivity(new Intent(LoginActivity.this, MyFirebase.class));
                                            finish();
                                        }
                                    ...
                                    Intent intent = new Intent(LoginActivity.this,MyFirebase.class);
